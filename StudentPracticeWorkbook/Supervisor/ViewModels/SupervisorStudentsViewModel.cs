...
{
    public class SupervisorStudentsViewModel : BindableBase
    {
        private readonly UserService _userService;
        private readonly RoleService _roleService;

        public SupervisorStudentsViewModel(UserService userService, RoleService roleService)
        {
            _userService = userService;
            _roleService = roleService;

            UsersList = new ObservableCollection<UserDTO>(_userService.Find(x=>x.Role.Name == AppRoles.Student.ToString()));
